...
public interface UserMapper {
	...
	List<Map<String, Object>> getAlluserTenKhoa();
    List<Map<String, Object>> getAlluserTenKhoaTheoten(Map<String, Object> fullname);

    List<Map<String, Object>> getAlluserTenKhoaTheoId(Map<String, Object> ma);
}